 ...
 */
public class LoanSortFragment extends DialogFragment {

    private CompleteListener completeListener;

    public static LoanSortFragment newInstance(String s) {
        LoanSortFragment frag = new LoanSortFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        sortModels.add(new SortModel(getString(R.string.loanAmount), "L.VALUE"));
        sortModels.add(new SortModel(getString(R.string.dayOfMonth), "L.DAY_IN_MONTH"));
        sortModels.add(new SortModel(getString(R.string.installment), "L.INSTALLMENT"));
        sortModels.add(new SortModel(getString(R.string.installmentAmount), "L.INSTALLMENT_AMOUNT"));
        sortModels.add(new SortModel(getString(R.string.settled), "L.SETTLED"));
        sortModels.add(new SortModel(getString(R.string.receiveDate), "L.DATE"));
        ...
        sortHeader.setBackgroundColor(Color.parseColor("#283593"));
        descSort.setTextColor(Color.parseColor("#283593"));
        ascSort.setTextColor(Color.parseColor("#283593"));
