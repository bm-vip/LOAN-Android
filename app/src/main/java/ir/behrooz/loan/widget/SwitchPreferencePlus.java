...
public class SwitchPreferencePlus extends SwitchPreferenceCompat {

    private final static String PATH_TO_FONT = Constants.IRANSANS_LT;
    private final static int DEFAULT_ICON_SIZE = 14;
    private final static int DEFAULT_ICON_COLOR = Color.GRAY;
    private Typeface font;
    AttributeSet attrs;

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SwitchPreferencePlus(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        this.attrs = attrs;
    }

    public SwitchPreferencePlus(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.attrs = attrs;
    }

    public SwitchPreferencePlus(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.attrs = attrs;
    }
