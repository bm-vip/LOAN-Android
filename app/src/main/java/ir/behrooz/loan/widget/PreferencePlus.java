...
public class PreferencePlus extends Preference {
    ...
    public PreferencePlus(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.attrs = attrs;
    }

    public PreferencePlus(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.attrs = attrs;
    }

    public PreferencePlus(Context context) {
        super(context);
    }
