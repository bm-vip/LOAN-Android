...
public class TextViewWithCircularIndicator extends AppCompatTextView {
    ...
    public void drawIndicator(boolean drawCircle) {
        ...
        // Update content description based on the drawCircle value
    ...
    private void updateContentDescription() {
        ...
        if (mDrawCircle) {
            setContentDescription(String.format(mItemIsSelectedText, itemText));
        } else {
            setContentDescription(itemText);
        }
    }
}
